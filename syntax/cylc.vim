...
syn region jinja2PreProc start='{%' end='%}'
syn region jinja2Include start='{{' end='}}'
syn region jinja2Define start='{#' end='#}'

syn region cylcSection start='\[' end='\]' contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define
syn region cylcSection start='\[\[' end='\]\]' contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define
syn region cylcSection start='\[\[\[' end='\]\]\]' contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define
...
syn match cylcComment /#.*/ contains=trailingWS,cylcToDo,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define

"syn region cylcString start=+'+ skip=+\\'+ end=+'+ contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define,cylcComment,trigger,output,suicide,offset,cylcToDo
"syn region cylcString start=+"+ skip=+\\"+ end=+"+ contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define,cylcComment,trigger,output,suicide,offset,cylcToDo
syn match cylcString /=\@<= *[^\"].*$/ contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define,cylcComment,trigger,output,suicide,offset,cylcToDo
syn region cylcString start=+=\@<= *"""+ end=+"""+ contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define,cylcComment,trigger,output,suicide,offset,cylcToDo
"syn region cylcString start=+=\@<= *'''+ end=+'''+ contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define,cylcComment,trigger,output,suicide,offset,cylcToDo
"syn match cylcString /=\@<= *\[^'"\].*/ contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define,cylcComment,trigger,output,suicide,offset,cylcToDo
"syn match cylcString /= *[^'"].*/ contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define,cylcComment,trigger,output,suicide,offset,cylcToDo
"syn match cylcString /".*"/ contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define,cylcComment,trigger,output,suicide,offset,cylcToDo
"syn match cylcString /'.*'/ contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define,cylcComment,trigger,output,suicide,offset,cylcToDo
"contains=trailingWS,lineCon,badLineCon,jinja2PreProc,jinja2Include,jinja2Define,cylcComment,trigger,output,suicide,offset,cylcToDo
...
hi def link jinja2PreProc PreProc
hi def link jinja2Include Include
hi def link jinja2Define Define
"CursorColumn
